(function (){
	...
	*/
	function showOperationMessage(operador, numberA, numberB){
		return `A operação ${numberA} ${operador} ${numberB} = `;
	}
	...
	*/
	...
	operationSignal = "!";
	let erro = calculator(operationSignal)
