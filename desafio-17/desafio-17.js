(function(){
	...
	*/
	...
	let myRegExp = text.replace(/Manuel Marques de Sousa/gm, "Rubens Filipe")
	console.log( text.replace(/Manuel Marques de Sousa/gm, "Rubens Filipe") );
	...
	*/
	...
	let myRegExpTwo = myRegExp.replace(/brasileiro/gm, "Recifense")
	console.log( text.replace(/brasileiro/gm, "Recifense") )
	console.log( myRegExpTwo )
	...
	*/
	...
	let myRegExpThree = myRegExpTwo.replace(/\d[0-9]/gm, "-")
	console.log( text.replace(/\d[0-9]/gm, "-") )
	console.log( myRegExpThree )
	...
	*/
	...
	let myRegExpFour = myRegExpThree.replace(/[$dh|DH]/gm, "0")
	console.log( text.replace(/[$dh|DH]/gm, "0") )
	console.log( myRegExpFour )
	...
	*/
	...
	let myRegExpFive = myRegExpFour.replace(/[A|a]/gm, "4")
	console.log( text.replace(/[A|a]/gm, "4") )
	console.log( myRegExpFive )
	...
	*/
	...
	let myRegExpSix = text.replace(/O Centauro de Luvas/gm, function (phrase){
		return phrase.toUpperCase()
	});

	let newTextRegExp = myRegExpFive.replace(/O Cent4uro 0e Luv4s/gm, function (phrase){
		return phrase.toUpperCase()
	});
	console.log( myRegExpSix, '\n',newTextRegExp )
	...
	*/
	...
	let myRegExpDate = /(\d\d) de (junho|julho) de (\d\d\d\d)/gm;
	console.log( myRegExpDate )
	...
	*/
	...
	function newDate(newRegExp, day, month, year){
		return day + '/' + getMonthNumber( month ) + '/' + year;
	}

	let dateRegExp = text.replace(myRegExpDate, newDate)
