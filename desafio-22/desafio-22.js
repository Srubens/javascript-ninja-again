(function(){
  ...
  */
  let objOne = { name: 'Rubens', lastName:'Filipe' }
  let objTwo = { name: 'Song', lastName:'Ferreira' }
  ...
  */
  ...
  console.log(getFullName.call(objOne))
  console.log(getFullName.call(objTwo))
  ...
  */
  ...
  console.log(justNumbers('r4b3ns 80, 7'))
