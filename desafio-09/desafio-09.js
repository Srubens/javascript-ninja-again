(function (){
    ...
    */
    ...
    let multiplication = calculator(12,5);
    let division = calculator(8,52);
    let mod = calculator(2,15);
    ...
    */
    ...
    console.log( `O resultado da subtração é: ${sum(function (a,b){ return a - b } )}` );

    console.log( 'O resultado da multiplicação é:' );
    console.log( `O resultado da multiplicação é: ${sum(function (a,b){ return a * b } )}` );

    console.log( 'O resultado da divisão é:' );
    console.log( `O resultado da divisão é: ${sum(function (a,b){ return a / b } )}` );

    console.log( 'O resto da divisão é:' );
    console.log( `O resultado do resto da divisão é: ${sum(function (a,b){ return a % b } )}` );
