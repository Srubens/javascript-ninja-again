(function(window, document){
    ...
    */
    let userEmail = prompt(`Qual é o seu email?`)
    if(!userEmail)
        userEmail = `Usuario não informou o seu email`;
    alert(`Seu email é: ${userEmail}`)
    ...
    */
    $button.addEventListener('click', (e)=>{
        ...
        return alert(`${$inputUsername} sua mensagem foi enviada com sucesso!`)
