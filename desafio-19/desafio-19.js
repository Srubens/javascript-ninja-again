(function (){
	...
	*/
	...
	var justNumberRegExp = new RegExp('^\\d+','gm')
	console.log(justNumberRegExp)
	...
	*/
	...
	console.log( text.match(justNumberRegExp) )
	...
	*/
	...
	function hasClass(markup, cssClass){
		let myRegExp = new RegExp('class=["\'](?:[\\w\\s]+)?'+ cssClass + '(?:[\\w\\s]+)?["\']' )
	...
	classes.forEach((cssClass)=>{
		console.log( hasClass(markup, cssClass) + ' para a classes:' + cssClass)
	})
